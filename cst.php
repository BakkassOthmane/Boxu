    ...
    <main>
        ...
        <section class="write-order">
                <form class="order-form">
                    <div class="form-content">
                        ...
                        <div class="order-field-2">
                            ...
                            <textarea name="messageBox" id="message-box" >
                            </textarea>
                        </div>
                    </div>
                ...
                <div class="order-btn-container">
                        <button  class="submit-order">Send</button>
                    </div>
        </section>
    </main>
    <footer>
